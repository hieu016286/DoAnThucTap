                        ...
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img"
                                     src="{{ asset('front/img/products/'.$product->productImages[0]->path) }}" alt="">
                                <div class="zoom-icon">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    @foreach($product->productImages as $productImage)
                                        <div class="pt active"
                                             data-imgbigurl="{{ asset('front/img/products/'.$productImage->path) }}">
                                            <img src="{{ asset('front/img/products/'.$productImage->path) }}" alt="">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="product-details">
                                ...
                                <div class="quantity">
                                    <div class="quantity">
                                        ...
                                        <a href="#" class="primary-btn pd-cart">Add To</a>
                                    </div>
                                </div>
                                <ul class="pd-tags">
                                            ...
                                            @foreach($product->productComments as $productComment)
                                                <div class="co-item">
                                                    <div class="avatar-pic">
                                                        <img
                                                            src="{{ !empty($productComment->user->avatar) ? asset('front/img/user/'.$productComment->user->avatar) : 'default-avatar.jpg' }}"
                                                            alt="">
                                                    </div>
