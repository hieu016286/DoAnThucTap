            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>Xuan Dinh - Bac Tu Liem - Ha Noi</li>
                            <li>Phone: 0328698912</li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            Copyright @<script>document.write(new Date().getFullYear());</script>  All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Hieu.
                        </div>
