...
(function ($) {
   ...
   $(".product-slider").owlCarousel({
	...
	var rangeSlider = $(".price-range"),
        ...
        let minValue = rangeSlider.data('min-value') !== '' ? rangeSlider.data('min-value') : minPrice;
        let maxValue = rangeSlider.data('max-value') !== '' ? rangeSlider.data('max-value') : maxPrice;
	    rangeSlider.slider({
		range: true,
		min: minPrice,
        max: maxPrice,
